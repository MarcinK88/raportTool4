...
<form:form method="post" modelAttribute="ticket" cssClass="form-horizontal">
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <form:input path="requestId" id="requestId" name="requestId" type="text" placeholder="Request ID" cssClass="form-control input-md"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <form:select id="requestType" name="requestType" class="form-control" path="requestType" items="${requestType}" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <form:input path="certificateName" id="certificateNam" name="certificateNam" type="text" placeholder="Certificate name" class="form-control input-md" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <form:input path="domainTotalNumberTag" id="domainTotalNumberTag" name="domainTotalNumberTag" type="text" placeholder="Domain total number/tag" class="form-control input-md" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <form:select path="requestOwner" id="requestOwner" name="requestOwner" class="form-control" items="${ticketOwners}" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <form:input path="requestContributor" id="requestContributor" name="requestContributor" type="text" placeholder="Request contributor" class="form-control input-md" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <form:input path="year" id="year" name="year" type="text" placeholder="Year" class="form-control input-md" />
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <form:input path="openDate" id="openDate" name="openDate" type="date" placeholder="Open date" class="form-control input-md" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <form:input path="openCw" id="openCw" name="openCw" type="text" placeholder="Open CW" class="form-control input-md" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <form:input path="openMonth" id="openMonth" name="openMonth" type="text" placeholder="Open month" class="form-control input-md" />
            </div>
        </div>
...
<%--                <c:if test="${empty ticket.closeDate}">${param.get{ticket} </c:if>--%>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <form:input path="resolutionTimeInDays" id="resolutionTimeInDays" name="resolutionTimeInDays" type="text" placeholder=" Resolution time (in days)" class="form-control input-md" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <form:input path="size" id="size" name="size" type="text" placeholder="Size" class="form-control input-md" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <form:input path="providerName" id="providerName" name="providerName" type="text" placeholder="Provider name" class="form-control input-md" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <form:input path="providerRefNo" id="providerRefNo" name="providerRefNo" type="text" placeholder="Provider Ref.NO" class="form-control input-md" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <form:input path="requester" id="requester" name="requester" type="text" placeholder="Requester" class="form-control input-md" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <form:input path="comments" id="comments" name="comments" type="text" placeholder="Comments" class="form-control input-md" />
            </div>
        </div>
